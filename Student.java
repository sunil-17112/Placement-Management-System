...
class Student{
	public ArrayList<String> Get_Company_offer=new ArrayList<String>();
	public ArrayList<String> eligible_company=new ArrayList<String>();
	public ArrayList<Integer> Tech_Score=new ArrayList<Integer>();
